...
public class AmazonAmazonCheckoutPage extends BaseScript{
	...
	/**
	 * Verify pag load is completed
	 */
	public AmazonCheckoutPage verifyCheckOutPaymentsPageDisplayed() {
		try {
			waitForPageToLoad();
			TestReporter.AssertTrueWithScreenshot(buttonContinue.isDisplayed(),"Verify CheckOut page payment is loaded");
		} catch (NoSuchElementException e) {
			Assert.fail("Failed to load amazon checkout page payment page");
		}
		return this;
	}
	 ...
	 * Bank Selection
	 */
	public AmazonCheckoutPage selectBankName() {
	 ...
	 */
	public AmazonCheckoutPage clickNetBankingRadioButton() {
		try {
	 ...
	 */
	public AmazonCheckoutPage clickContinueButton() {
		try {
	 ...
	 */
	public AmazonCheckoutPage compareItemNames(String actualValue, String expectedValue) {
		try {
