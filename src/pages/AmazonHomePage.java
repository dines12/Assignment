...
public class AmazonAmazonHomePage extends BaseTestPage{
	...
	public void waitForPageToLoad() {
		...
		System.out.print("Clicked on close language selection");
			...
			Assert.fail("Failed to load amazon Home Page");
		}
	}
	
		public AmazonHomePage verifyAmazonHomePageDisplayed() {
	...
	public AmazonHomePage EnterKeywordAndSearchItem() {
		try {
